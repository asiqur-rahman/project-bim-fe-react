                    ...
                    {({ isDragActive, getRootProps, getInputProps, isDragReject, acceptedFiles, rejectedFiles  }) => (
                        <div className="dropzone text-center">
                            <div className="dz-message py-5 needsclick" {...getRootProps()}>
                                ...
                                <h3>Drop here or click to upload.</h3>
                                <span className="text-muted font-13">
                                    (Please upload <strong>{this.props.fileType}</strong> file. Max : {this.props.maxSize/1000000}mb)
                                    {isDragReject && "File type not accepted, sorry!"}
                                    {rejectedFiles.length > 0 && rejectedFiles[0].size > this.props.maxSize && (
