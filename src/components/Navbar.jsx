        ...
        <div className="mobile-responsive-nav">
            <div className="container">
                <div className="mobile-responsive-menu">
                    <div className="logo">
                        <a href="index.html">
                            <img style={{height:"52px"}} src="/logo.png" className="main-logo" lt="logo"/>
                            <img style={{height:"52px"}} src="/logo.png" className="white-logo" alt="logo"/>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div className="container-fluid">
                <nav className="navbar navbar-expand-md navbar-light">
                    <a className="navbar-brand" href="index.html">
                        <img style={{height:"52px"}} src="assets/images/logo.png" alt="logo"/>
                    </a>
