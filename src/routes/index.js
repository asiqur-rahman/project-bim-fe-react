...
//omrTemplate
const CreateOMRTemplate = React.lazy(() => import('../pages/omrTemplate/CreateOMRTemplate'));
const OMRTemplatesList = React.lazy(() => import('../pages/omrTemplate/OMRTemplatesList'));

// omrCheck
const CreateNewRequest = React.lazy(() => import('../pages/omrCheck/CreateNewRequest'));
const RequestsList = React.lazy(() => import('../pages/omrCheck/RequestsList'));
...
// apps
const omrTemplateAppRoutes = {
    path: '/apps/omrTemplate',
    name: 'OMR Template',
    header: 'OMR',
    ...
    children: [
        {
            path: '/apps/omrTemplate/new-request',
            name: 'Create New Template',
            component: CreateOMRTemplate,
            route: PrivateRoute,
            roles: ['Admin'],
        },
        {
            path: '/apps/omrTemplate/requests',
            name: 'Templates List',
            component: OMRTemplatesList,
            route: PrivateRoute,
            roles: ['Admin'],
        }
    ]
...
const omrCheckAppRoutes = {
    ...
    children: [
        {
            path: '/apps/omrCheck/new-request',
            name: 'New Request',
...
const appRoutes = [omrTemplateAppRoutes, omrCheckAppRoutes, calendarAppRoutes, emailAppRoutes, projectAppRoutes, taskAppRoutes];
